"""
STATE
Code as a state machine or a state algorithm
* Algorithm can be in only a certain number of predefined states
* Transition to states in given direction only
